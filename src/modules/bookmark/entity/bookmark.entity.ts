...
@InputType('BookmarkInputType', { isAbstract: true })
@ObjectType()
@Schema({ collection: CollectionName.BOOKMARK })
export class BookmarkEntity extends DefaultEntity {
...
type TBookmark = Document<BookmarkEntity>;
const BookmarkSchema = SchemaFactory(BookmarkEntity);

export { BookmarkSchema, TBookmark };
